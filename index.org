...
|------------+--------+---------+------------|
| Long Call  |     50 | $1.27   | 1 month    |
| Short Call |     50 | $1.98   | 2 months   |
|------------+--------+---------+------------|

The premia were determined using the Black-Scholes model with a constant volatility of 30%, a 1% risk free rate, and a $49 stock price.
